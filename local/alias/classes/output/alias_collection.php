...
class alias_collection implements renderable {
    ...
    /** @var int number of aliases to display per page */
    public $perpage = ALIAS_PERPAGE;

    /** @var int the total number of aliases to display */
    ...
    /**
     * Initializes the list of aliases to display
     *
     * @param array $aliases to render
     */
