...
$result = $alias->get_aliases($urlparams['search'], $urlparams['page'], $urlparams['sort'], $urlparams['dir']);

if ($result->total > 0) {
    $output                 = $PAGE->get_renderer('local_alias');
    $aliases                = new \local_alias\output\alias_collection($result->records);
    ...
    $aliases->totalcount    = $result->total;
