...
class behat_core_generator extends behat_generator_base {
    ...
    protected function process_setup_backpack_connected(array $data) {
        ...
        $backpackoauth2->scope = "https://purl.imsglobal.org/spec/ob/v2p1/scope/assertion.create https://purl.imsglobal.org/spec/ob/v2p1/scope/assertion.readonly offline_access";
        $recordid = $DB->insert_record('badge_backpack_oauth2', $backpackoauth2, true);
