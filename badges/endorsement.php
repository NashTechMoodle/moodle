...
if ($form->is_cancelled()) {
    ...
    $record = $DB->get_record_select('badge_endorsements', 'badgeid = ?', array($badgeid));
    if ($record) {
        $endorsement->id = $record->id;
        $DB->update_record('badge_endorsements', $endorsement);
    } else {
        $DB->insert_record('badge_endorsements', $endorsement);
    }
}
