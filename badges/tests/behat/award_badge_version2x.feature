@core @core_badges @_file_upload @badge_version2
Feature: Award badges
  ...
  Scenario: Award profile badge
    ...
    And I set the following fields to these values:
      | Name | Profile Badge Version 2.x |
      | Open Badges Specification Version | Version 2.x|
      | version | Badge Version 2.x |
    ...
    Then I should see "Profile Badge Version 2.x"
  ...
  Scenario: Award site badge
    ...
    And I navigate to "Add a new badge" node in "Site administration > Badges"
    And I set the following fields to these values:
      | Name | Site Badge Version 2.x |
      | Open Badges Specification Version | Version 2.x|
      | version | Badge Version 2.x |
      | Description | Site badge version 2.x description |
      | issuername | Tester of site badge version 2.x|
      | issuercontact | testuser@example.com |
    And I upload "badges/tests/behat/badge1.png" file to "Image" filemanager
    And I press "Create badge"
    ...
    And I follow "Profile" in the user menu
    Then I should see "Site Badge Version 2.x"
  ...
  Scenario: Award course badge
    ...
    And I set the following fields to these values:
      | Name | Course Badge Version 2.x|
      | Open Badges Specification Version | Version 2.x|
      | version | Course Badge Version 2.x |
      | Description | Course badge verison 2.x description |
  ...
  Scenario: Award badge on activity completion
    ...
    And I set the following fields to these values:
      ...
      | Open Badges Specification Version | Version 2.x|
      | version | Course Badge Version 2.x |
      | Description | Course badge version 2.x description |
      | issuername | Tester of course badge verison 2.x |
      | issuercontact | testuser@example.com |
    And I upload "badges/tests/behat/badge1.png" file to "Image" filemanager
    And I press "Create badge"
    ...
    And I follow "Profile" in the user menu
    And I click on "Course 1" "link" in the "region-main" "region"
    Then I should see "Course Badge Version 2.x"
  ...
  Scenario: All of the selected roles can award badges
    ...
    And I follow "Add a new badge"
    And I set the following fields to these values:
      | Name | Course Badge 1 Version 2.x|
      | Description | Course badge version 2.x description |
      | issuername | Tester of course badge verison 2.x |
    And I upload "badges/tests/behat/badge1.png" file to "Image" filemanager
    And I press "Create badge"
    ...
    And I set the field "potentialrecipients[]" to "Student 1 (student1@example.com)"
    When I press "Award badge"
    And I follow "Course Badge 1 Version 2.x"
    ...
    And I follow "Add a new badge"
    And I set the following fields to these values:
      | Name | Course Badge 2 Version 2.x|
      | Open Badges Specification Version | Version 2.x|
      | version | Badge Version 2.x |
      | Description | Course badge 2 verision 2.x description |
      | issuername | Tester of course badge 2 verison 2.x|
      | issuercontact | testuser@example.com |
    ...
    And I set the field "potentialrecipients[]" to "Student 2 (student2@example.com)"
    When I press "Award badge"
    And I follow "Course Badge 2 Version 2.x"
    And I follow "Recipients (1)"
    Then I should see "Recipients (1)"
    And I log out
    And I trigger cron
    ...
    Then I should see "Course Badge 1 Version 2.x"
    And I should not see "Course Badge 2 Version 2.x"
    And I log out
    # Student 2 should have just course badge 2.
    And I log in as "student2"
    And I follow "Profile" in the user menu
    When I click on "Course 1" "link" in the "region-main" "region"
    Then I should see "Course Badge 2 Version 2.x"
    Then I should not see "Course Badge 1 Version 2.x"
  ...
  Scenario: Revoke badge
    ...
    And I set the following fields to these values:
      ...
      | version | Badge Version 2.x |
      | Description | Course badge version 2.x description |
      | issuername | Tester of course badge veriosn 2.x |
      | issuercontact | testuser@example.com |
    And I upload "badges/tests/behat/badge1.png" file to "Image" filemanager
    And I press "Create badge"
    And I set the field "type" to "Manual issue by role"
    ...
    And I set the field "potentialrecipients[]" to "Student 1 (student1@example.com)"
    When I press "Award badge"
    And I follow "Course Badge Version 2.x"
    Then I should see "Recipients (2)"
