...
class core_badges_badgeslib_v2_testcase extends advanced_testcase {
    protected $badgeid;
    protected $course;
    protected $user;
    protected $module;
    ...
    protected function setUp() {
        ...
        $fordb = new stdClass();
        $fordb->id = null;
        $fordb->name = "Test badge version 2";
        $fordb->description = "Testing badges version 2";
        ...
        $fordb->authorimage = "Test author image";
        ...
        $DB->insert_record('badge_endorsements', $endorsement, true);
        ...
        $this->assertion->badge = '{"uid":"%s","recipient":{"identity":"%s","type":"email","hashed":true,"salt":"%s"},"badge":{"name":"%s","description":"%s","image":{"id":"%s","author":"%s","caption":"%s"},"criteria":{"id":"%s","narrative":"%s"},"issuer":{"name":"%s","url":"%s","email":"%s","@context":"https:\/\/w3id.org\/openbadges\/v2","id":"%s","type":"Issuer"},"@context":"https:\/\/w3id.org\/openbadges\/v2","id":"%s","type":"BadgeClass","version":"%s","@language":"%s","related":{"id":"%s","version":"%s","@language":"%s"},"endorsement":"%s","alignment":[{"targetName":"%s","targetUrl":"%s","targetDescription":"%s","targetFramework":"%s","targetCode":"%s"}]},"verify":{"type":"hosted","url":"%s"},"issuedOn":"%s","evidence":"%s","@context":"https:\/\/w3id.org\/openbadges\/v2","type":"Assertion"}';
        $this->assertion->class = '{"name":"%s","description":"%s","image":{"id":"%s","author":"%s","caption":"%s"},"criteria":{"id":"%s","narrative":"%s"},"issuer":{"name":"%s","url":"%s","email":"%s","@context":"https:\/\/w3id.org\/openbadges\/v2","id":"%s","type":"Issuer"},"@context":"https:\/\/w3id.org\/openbadges\/v2","id":"%s","type":"BadgeClass","version":"%s","@language":"%s","related":{"id":"%s","version":"%s","@language":"%s"},"endorsement":"%s","alignment":[{"targetName":"%s","targetUrl":"%s","targetDescription":"%s","targetFramework":"%s","targetCode":"%s"}]}';
        $this->assertion->issuer = '{"name":"%s","url":"%s","email":"%s","@context":"https:\/\/w3id.org\/openbadges\/v2","id":"%s","type":"Issuer"}';
    }
