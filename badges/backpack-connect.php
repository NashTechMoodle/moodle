...
if ($action == 'unauthorization') {
    $redirecturl = new moodle_url('/badges/mybadges.php', ['success' => 'backpackdisconnected']);
    \core_badges\oauth2\auth::disconnect($externalbackpack, $redirecturl);
} else {
    ...
    if ($persistedissuer) {
        ...
        if ($client) {
            ...
            $wantsurl = new moodle_url('/badges/mybadges.php', ['success' => 'backpackconnected']);
