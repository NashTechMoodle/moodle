...
if (($hassiteconfig || has_any_capability(array(
    ...
    $backpacksettings->add(new admin_setting_configcheckbox('badges_backpacknewversion',
        new lang_string('backpacknewversion', 'badges'),
        new lang_string('backpacknewversion_desc', 'badges'), 0));
