...
$string['backpackconnectto'] = 'Connect to {$a}';
$string['backpackdetails'] = 'Backpack settings';
$string['backpackdisconnect'] = 'Disconnect {$a}';
...
$string['backpackexportto'] = 'Export to {$a}';
$string['backpackexporterror'] = 'Can\'t export {$a} to backpack';
$string['backpackexportsuccess'] = 'Export {$a} is successful.';
...
$string['backpackimportfrom'] = 'Import from {$a}';
$string['backpackimporterror'] = 'Can\'t importing badges from backpack';
$string['backpackimportsuccess'] = 'Import badges is successful';
$string['backpacksettings'] = 'Backpack settings';
$string['backpacknewversion'] = 'Badges v2.1 supported';
$string['backpacknewversion_desc'] = 'Content is updating';
...
$string['confirmbadgesexport'] = 'Confirm badges export to {$a}';
$string['confirmbadgesrequired'] = 'Select at least a badge to export';
